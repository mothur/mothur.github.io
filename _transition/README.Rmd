...
* once site is up...
	...
	- connect disqus comments with


* long term
  - Set up CI to confirm pull requests
  ...
  - make separate pages for tags, create three/four column listing of tags
    ...
    - align.report_file
  	- Jensen-Shannon Divergence
		...
		- shannonrange
    - citation page
			* general update of citations for different function (more for mothur than wiki)
			* might be nice to make these citations available in [bibTex format](https://www.doi2bib.org/#/doi/)
