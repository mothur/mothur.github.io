---
title: 'Human gut'
redirect_from: '/wiki/Human_gut'
---
Here is a link to NCBI definition page for the [human\_gut
package](https://www.ncbi.nlm.nih.gov/biosample/docs/packages/MIMARKS.survey.human-gut.4.0/).
...
### gastrointest\_disord

The history of gastrointestinal tract disorders; can include multiple
disorders.
...
The history of liver disorders; can include multiple disorders.
...
The specification of special diet; can include multiple special diets.

    format: [, 'low carb', 'reduced calorie', 'vegetarian', 'other(to be specified)']
