...
convert_mw_to_md <- function(mediawiki_file){
	...
	stub <- str_replace(markdown_file, "_wiki/(.*).md", "\\1") %>% tolower()
	bold_stub <- paste0("**", stub, "**")
	link_stub <- paste0("\\[", stub, "\\]\\(", stub, "\\)")
	md <- str_replace(md, link_stub, bold_stub)

	md <- str_replace(md, paste0(" ", stub, " "), paste0(" ", bold_stub, " "))
...
## To do...
* categories - Possible to make tags and have a page for each tag?
