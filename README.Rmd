...
* data
  - Missing data
    + MiSeqDevelopmentData
		+ maybe retry data/FamilyStudy/family.metagenome.bz2.tar

* wiki
  - fresh pull from old wiki
...
* once site is up...
  ...
  * Manual fixing
	...
	- Add filetypes tag to file types, remove file type page and link, if needed
	- Clean up "Analysis examples" page
	- Put link to "Analysis examples" in "mothur_manual"
	- Give FAQ page section headers to generate TOC, capitalize title
	- Check alt text and sizing of figures, e.g...
	  ```
		![AMS Page](https://mothur.s3.us-east-2.amazonaws.com/wiki/aws_pick_region.png){: width="200px"}
		```
	- Clear errors...
	```
